...
#  Created on Sun Jan 24 16:17:03 2021                
#                                                     
#######################################################
...
set init_verilog ../netlist/Risc_V.v
...
selectWire 33.6900 23.5550 35.0900 23.6250 3 {ID_Stage_Register_FIle_Register_file[460]}
getFillerMode -quiet
...
saveDesign design/Risc_V.enc
reset_parasitics
extractRC
rcOut -setload output/Risc_V.setload -rc_corner my_rc
rcOut -setres output/Risc_V.setres -rc_corner my_rc
rcOut -spf output/Risc_V.spf -rc_corner my_rc
rcOut -spef output/Risc_V.spef -rc_corner my_rc
reset_parasitics
extractRC
...
reportGateCount -level 5 -limit 100 -outfile Risc_V.gateCount
saveNetlist Risc_V_end.v
all_hold_analysis_views 
all_setup_analysis_views 
write_sdf  -ideal_clock_network Risc_V_end.sdf
reset_parasitics
extractRC
rcOut -setload Risc_V.setload -rc_corner my_rc
rcOut -setres Risc_V.setres -rc_corner my_rc
...
read_activity_file -format VCD -scope /testbench/DUT -start {} -end {} -block {} ../vcd/Risc_V_innovus.vcd
set_power -reset
set_powerup_analysis -reset
set_dynamic_power_simulation -reset
report_power -rail_analysis_format VS -outfile .//Risc_V.rpt
