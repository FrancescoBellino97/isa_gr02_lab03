...
analyze -f vhdl -lib WORK ../src/module_block.vhd
...
elaborate Risc_V -arch structural -lib WORK > ./output_report/elaborate_F4.txt
uniquify
link

create_clock -name MY_CLK -period 14.00 Clk
...
report_timing > ./output_report/reportTiming_F4.txt
report_area > ./output_report/reportArea_F4.txt
